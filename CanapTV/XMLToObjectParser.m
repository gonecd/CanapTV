	...
	attributes:(NSDictionary *)attributeDict
{
    if([elementName isEqualToString:@"programme"]) {
        ...
        [item setValue:[attributeDict objectForKey:@"channel"] forKey:@"chaine"];
        //NSLog(@"id = %@ , %i", [attributeDict objectForKey:@"channel"], [[[attributeDict objectForKey:@"channel"] substringFromIndex:1] intValue]);
        //REVOLUTION [item setValue:[NSNumber numberWithInt:[[[attributeDict objectForKey:@"channel"] substringFromIndex:1] intValue]] forKey:@"numChaine"];
        ...
        [item setValue:@"" forKey:@"icone"];
        [item setValue:[attributeDict objectForKey:@"id"] forKey:@"idchaine"];
        
        //REVOLUTION [item setValue:[NSNumber numberWithInt:[[[attributeDict objectForKey:@"id"] substringFromIndex:1] intValue]] forKey:@"numChaine"];
    
	}
    else if([elementName isEqualToString:@"icon"]) { if ([[item valueForKey:@"icone"] isEqualToString:@""]) { [item setValue:[attributeDict objectForKey:@"src"] forKey:@"icone"];} }
	else {
 ...
 qualifiedName:(NSString *)qName
{
    ...
    //REVOLUTION else if([elementName isEqualToString:@"display-name"])      { [item setValue:currentNodeContent forKey:@"nomChaine"]; }
